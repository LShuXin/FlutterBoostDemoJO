                    ...
                    child: Column(
                        ...
                        children: <Widget>[
                            InkWell(
                                ...
                                onTap: () => Navigator.of(context).pop('I am Navigator from MediaQueryRouteWidget too!'),
                            ),
                            InkWell(
                                child: Container(
                                    padding: const EdgeInsets.all(8.0),
                                ...
                                onTap: () => BoostNavigator.instance.pop('I am BoostNavigator from MediaQueryRouteWidget!'),
                            ),
                        ],
                    ),
                ),
